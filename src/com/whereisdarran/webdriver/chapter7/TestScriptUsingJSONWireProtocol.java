...
public class TestScriptUsingJSONWireProtocol {
    ...
    public static void main(String... args){
        ...
        try {
            ...
            postMethod = new HttpPost("http://127.0.0.1:4444/wd/hub/session");
            ...
            getMethod  = new HttpGet("http://127.0.0.1:4444/wd/hub/sessions");
            ...
            httpClient = new DefaultHttpClient();
            postMethod  = new HttpPost("http://127.0.0.1:4444/wd/hub/session/"+sessionId+"/url");
            jo=new JSONObject();
            ...
            httpClient = new DefaultHttpClient();
            postMethod = new HttpPost("http://127.0.0.1:4444/wd/hub/session/"+sessionId+"/element");
            jo=new JSONObject();
            jo.put("using","name");
            jo.put("value","q");
            input = new StringEntity(jo.toString());
            ...
            //Click on SearchBox
            httpClient = new DefaultHttpClient();
            postMethod = new HttpPost("http://127.0.0.1:4444/wd/hub/session/"+sessionId+"/element/"+searchBoxId+"/click");
            response = httpClient.execute(postMethod);


            // Type Packt Publishing in SearchBox
            httpClient = new DefaultHttpClient();
            postMethod = new HttpPost("http://127.0.0.1:4444/wd/hub/session/"+sessionId+"/element/"+searchBoxId+"/value");
            jo=new JSONObject();
            ...
            // End the Session
            httpClient = new DefaultHttpClient();
            deleteMethod = new HttpDelete("http://127.0.0.1:4444/wd/hub/session/"+sessionId);
